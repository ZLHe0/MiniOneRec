...
from trainer_wandb import Trainer

def parse_args():
    parser = argparse.ArgumentParser(description="RQVAE Index Training with WandB")
    ...
    parser.add_argument("--ckpt_dir", type=str, default="./output_replication", help="output directory for model")

    # WandB arguments
    parser.add_argument("--wandb_project", type=str, default="rqvae-replication", help="WandB project name")
