#!/bin/bash
# RL script for Office_Products with RULE-ONLY reward, configured for 4 GPUs (3,4,5,6)
...
OUTPUT_DIR="./output/rl_rule_office_qwen2.5-1.5b-instruct"
