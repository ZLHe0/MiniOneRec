#!/bin/bash
# RL script for Office_Products with Sibling-GRPO + ranking reward (rule + ndcg_rule)
...
OUTPUT_DIR="./output/rl_sibling_office_qwen2.5-1.5b-instruct"
...
for category in "Office_Products"; do
    ...
    accelerate launch \
        ...
        --wandb_run_name rl_sibling_office \
