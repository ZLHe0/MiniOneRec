#!/bin/bash
# RL script for Office_Products with POSITION reward, configured for 8 GPUs
...
OUTPUT_DIR="./output/rl_position_office_qwen2.5-1.5b-instruct"
...
for category in "Office_Products"; do
    ...
    accelerate launch \
        ...
        --wandb_run_name rl_position_office \
